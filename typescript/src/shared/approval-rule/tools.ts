...
const tools: Record<string, Tool> = {
  read_approval_rule: {
    ...
    parameters: readApprovalRuleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
  ...
  create_approval_rule: {
    ...
    parameters: createApprovalRuleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
  ...
  update_approval_rule: {
    ...
    parameters: updateApprovalRuleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
...
export const contextToApprovalRuleTools = (context?: Context) => {
  if (context?.isAdmin || (context?.customerId && context?.businessUnitKey)) {
    return [
      tools.read_approval_rule,
      tools.create_approval_rule,
      tools.update_approval_rule,
    ];
  }
  return [];
};
