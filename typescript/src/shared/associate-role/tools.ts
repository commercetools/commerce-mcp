...
const tools: Record<string, Tool> = {
  read_associate_role: {
    ...
    parameters: readAssociateRoleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
  ...
  create_associate_role: {
    ...
    parameters: createAssociateRoleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
  ...
  update_associate_role: {
    ...
    parameters: updateAssociateRoleParameters as unknown as z.ZodObject<
      any,
      any,
      any,
      any
