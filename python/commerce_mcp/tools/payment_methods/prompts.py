READ_PAYMENT_METHOD_PROMPT = """Read payment methods from commercetools. You can:
...
CREATE_PAYMENT_METHOD_PROMPT = """Create a new payment method in commercetools.
...
UPDATE_PAYMENT_METHOD_PROMPT = """Update or delete a payment method in commercetools. You must identify the method using either ID or key.
